                ...
                if (document.getElementById('naorepete_form_gs')) {
                    ...
                    campo_insere_cogm.addEventListener('input', function () {
                        ...
                        for (var i = 0; i < guardas.length; i++) {
                            var check_guarda = document.querySelector('div[aria-label="' + cogm_gm_nome[cogm_gm_nr.indexOf(guardas[i].replace(/\D/g, ''))] + ', resposta para ' + cogm_funcoes[i] + '"]');
